...
export default function ContactFormDialog({ open, setOpen, children }: ContactFormDialogProps) {
  ...
  return (
    <div
      className={cn(
        'flex-center fixed top-0 left-0 z-50 size-full transition-all duration-300 ease-out',
    ...
    >
      <div
        ...
        className={cn(
          'absolute top-0 left-0 size-full bg-black/50 transition-all duration-300 ease-out',
