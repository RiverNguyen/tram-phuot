  ...
  return (
    <div className='xsm:h-[33.875rem] relative w-full h-[36.375rem]'>
      ...
      <div className='xsm:top-[27.4375rem] xsm:left-[1rem] xsm:gap-[1rem] absolute top-[24.6875rem] left-[7.125rem] inline-flex flex-col items-start gap-[2rem]'>
        ...
        />
        <h1 className='xsm:text-[1.25rem] xsm:leading-[1.375rem] xsm:tracking-normal xsm:font-medium text-white text-shadow-[0_4.702px_4.702px_rgba(0,0,0,0.50)] font-phudu text-[3rem] leading-[3.09rem] tracking-[-0.03rem] uppercase'>
