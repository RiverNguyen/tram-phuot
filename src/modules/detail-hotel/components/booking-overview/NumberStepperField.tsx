...
export default function NumberStepperField({ label, field }: NumberStepperFieldProps) {
  ...
  return (
    <div className='p-[0.6875rem_0.5rem_0.6875rem_1rem] h-[3.25rem] rounded-[0.75rem] border border-[#ededed] bg-[#f5f5f5] flex items-center justify-between'>
      ...
      <div className='flex items-center space-x-2'>
        <button
          ...
          className='size-[2rem] flex-center rounded-full bg-white border border-[#ddd] hover:bg-gray-50 transition-colors transform duration-300'
        >
