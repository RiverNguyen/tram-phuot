...
const Policy = ({ policy }: { policy: IHotelDetail['acf']['policy'] }) => {
  ...
  return (
    <section className='bg-white rounded-[0.5rem] mt-8 p-8 xsm:bg-transparent xsm:px-4 xsm:pb-8 xsm:pt-3 xsm:mt-0 xsm:rounded-none xsm:border-black/10 xsm:border-b'>
      ...
      <article
        className='[&_ul]:list-disc xsm:text-[0.875rem] xsm:[&_strong]:text-base [&_hr]:my-[1.125rem] [&_hr]:h-[0.0625rem] [&_hr]:bg-[#EDEDED] [&_ul]:list-inside [&_ul_li::marker]:text-orange-500 text-body-t1/75 leading-[1.5] [&_strong]:font-phu-du [&_strong]:font-bold [&_strong]:leading-[1.1] [&_strong]:text-[#2E2E2E]'
