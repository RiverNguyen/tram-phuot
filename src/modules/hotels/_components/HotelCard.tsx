...
export default function HotelCard({ hotel, className }: { hotel: IHotel; className?: string }) {
  ...
  return (
    ...
    >
      ...
      {/* content */}
      <div className='xsm:min-h-auto xsm:pt-[3.50288rem] xsm:px-[0.84069rem] xsm:pb-4 xsm:items-center absolute bottom-0 left-0 flex w-full min-h-[12.375rem] pt-[3.125rem] px-[0.75rem] pb-[1.1875rem] justify-between items-end bg-[linear-gradient(180deg,rgba(6,42,25,0.00)_0%,rgba(6,42,25,0.58)_24.91%,#062A19_100%)]'>
