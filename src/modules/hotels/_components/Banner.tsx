...
export default function Banner({ locale, data }: { locale?: string; data?: PageBannerACF }) {
  ...
  return (
    <div className='xsm:h-[43.25rem] relative h-[36.375rem] w-full'>
      ...
      />
      {/* overlay */}
      <div className='xsm:top-[0] xsm:h-[43.25rem] absolute top-[16.8125rem] left-0 h-[19.5625rem] w-full bg-[linear-gradient(180deg,rgba(0,0,0,0.00)_0%,rgba(2,3,5,0.08)_13.88%,#192842_100%)] opacity-[0.68]' />
      {/* content */}
