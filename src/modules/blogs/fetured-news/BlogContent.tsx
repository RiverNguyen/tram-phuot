    ...
    <div className={className}>
      <div className='xsm:mb-[1rem] mb-[2.5rem]'>
        ...
        <div className='font-montserrat flex items-center gap-[0.5rem] text-[0.875rem] leading-[0.625rem] font-semibold tracking-[-0.00875rem]'>
          ...
          <span className='text-[rgba(46,46,46,0.60)]'>{blog?.date}</span>
        </div>
        {/* title */}
        <h3 className='xsm:mt-[0.625rem] xsm:mb-[0.75rem] xsm:text-[1.25rem] xsm:leading-[1.5rem] xsm:tracking-[0.025rem] font-phu-du my-[1.25rem] line-clamp-2 text-[2.125rem] leading-[2.3375rem] font-medium text-[#1F4D37]'>
          {blog?.title}
        </h3>
        {/* description */}
        <p className='xsm:line-clamp-3 xsm:text-[0.875rem] xsm:leading-[1.3125rem] font-montserrat line-clamp-8 text-[1rem] leading-[1.5rem] text-[rgba(46,46,46,0.75)]'>
