...
export default function Banner({ locale, data }: { locale?: string; data?: PageBannerACF }) {
  ...
  return (
    <div className='xsm:h-[33.875rem] relative h-[36.375rem] w-full overflow-hidden'>
      ...
      />
      {/* overlay */}
      <div className='xsm:top-[14.8125rem] xsm:h-[19.5625rem] absolute top-[12.375rem] left-0 h-[24rem] w-full bg-[linear-gradient(180deg,rgba(0,0,0,0.00)_0%,rgba(2,3,5,0.08)_13.88%,#192842_100%)] opacity-[0.68] backdrop-blur-[2px]' />
      {/* content */}
