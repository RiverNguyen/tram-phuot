...
export type CouponFilterMap = Partial<
  Record<keyof CouponTaxonomies, FilterOption[]>
>
...
const COUPON_TAXONOMY_KEYS: (keyof CouponTaxonomies)[] = [
  'locations',
  'tour-type',
]

function isCouponTaxonomyKey(
  key: string,
): key is keyof CouponTaxonomies {
